...
"""
实验失败, 安装失败.
(v1.4) pkg> develop https://github.com/una-dinosauria/Rayuela.jl.git
Error: Error building `Rayuela`: 
│ ../src/encode_icm.cpp: In function ‘void _viterbi_encoding(unsigned char*, float*, float*, int, int)’:
│ ../src/encode_icm.cpp:77:19: error: variable-sized object ‘U’ may not be initialized
